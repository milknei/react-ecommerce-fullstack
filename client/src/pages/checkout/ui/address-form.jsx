...
export const AddressForm = ({ type, values, errors, touched, handleBlur, handleChange }) => {
  ...
  return (
    ...
    >
      ...
      />
      <Typography sx={{ mt: 1, gridColumn: 'span 4' }} variant="body1">
        Provide following information if you need physical copy of purchased products:
      </Typography>
      <TextField
        fullWidth
        type="text"
